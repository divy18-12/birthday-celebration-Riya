    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">[RIYA]</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">[RIYA]'s</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 FAV SIS — [RIYA] 💖</h2>
          <p className="final-subtitle">Always keep smiling and be happy ✨</p>
        </section>
      </div>
